...
if(EXISTS "${SRC_DIR}/httpserver")
    file(GLOB httpserver_files "${SRC_DIR}/httpserver/*")
    foreach(httpserver_file ${httpserver_files})
        message(STATUS "${httpserver_file} -> ${OUTPUT_DIR}")
        file(COPY "${httpserver_file}" DESTINATION "${OUTPUT_DIR}")
    endforeach()
endif()
