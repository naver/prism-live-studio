...
using namespace std;
using dataFunction = function<void(QNetworkReply *networkReply, int code, QByteArray data, void *context)>;
using dataErrorFunction = function<void(QNetworkReply *networkReply, int code, QByteArray data, QNetworkReply::NetworkError error, void *context)>;
...
public:
	...
	static void connectFinished(QNetworkReply *networkReply, const QObject *receiver = nullptr, dataFunction onSucceed = nullptr, dataErrorFunction onFailed = nullptr,
	...
	static void downloadImageAsync(QNetworkReply *reply, const QObject *receiver, const QString &saveDir, ImageCallback callback, const QString &saveFileNamePrefix,
				       const QString &saveFileName = QString(), const QString &defaultImagePath = QString(), void *context = nullptr, int iTimeout = PRISM_NET_REQUEST_TIMEOUT,
				       bool bPrintLog = true, bool isModifySuffix = true);
	static QPair<bool, QString> downloadImageSync(QNetworkReply *reply, const QObject *receiver, const QString &saveDir, const QString &saveFileNamePrefix, const QString &saveFileName = QString(),
						      const QString &defaultImagePath = QString(), int iTimeout = PRISM_NET_REQUEST_TIMEOUT, bool bPrintLog = true, bool isModifySuffix = true);
	static void downloadImagesAsync(QList<QNetworkReply *> &replyList, const QObject *receiver, const QString &saveDir, ImagesCallback callback, const QString &saveFileNamePrefix,
					...
					int iTimeout = PRISM_NET_REQUEST_TIMEOUT, bool bPrintLog = true, bool isModifySuffix = true);
