...
PLSCrashReport::PLSCrashReport(QWidget *parent, const char *text) : QDialog(parent)
{
	...
	resize(800, 600);
	setWindowTitle("Oops, PLS has crashed!");
}

void PLSCrashReport::ExitClicked()
{
	exit(-1);
}

void PLSCrashReport::CopyClicked()
{
