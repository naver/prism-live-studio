...
class AutoConfig : public PLSWizardView {
	Q_OBJECT
...
public:
	explicit AutoConfig(QWidget *parent);
	~AutoConfig();
...
public:
	explicit AutoConfigStartPage(QWidget *parent = nullptr);
	~AutoConfigStartPage();
...
public:
	explicit AutoConfigVideoPage(QWidget *parent = nullptr);
	~AutoConfigVideoPage();
...
public:
	explicit AutoConfigStreamPage(QWidget *parent = nullptr);
...
public:
	explicit AutoConfigTestPage(QWidget *parent = nullptr);
	~AutoConfigTestPage();
