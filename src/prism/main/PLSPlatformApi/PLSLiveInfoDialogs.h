...
int pls_exec_live_Info_navertv(const QString &which, const QVariantMap &info, QWidget *parent = PLSBasic::Get());
int pls_exec_live_Info_navertv(PLSPlatformNaverTV *platform, QWidget *parent = PLSBasic::Get());
...
int pls_exec_live_Info_naver_shopping_live(const QString &which, const QVariantMap &info, QWidget *parent = PLSBasic::Get());
int pls_exec_live_Info_naver_shopping_live(PLSPlatformNaverShoppingLIVE *platform, QWidget *parent = PLSBasic::Get());
