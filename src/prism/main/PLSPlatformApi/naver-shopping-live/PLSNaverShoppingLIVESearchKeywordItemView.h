...
private:
	...
	~PLSNaverShoppingLIVESearchKeywordItemView();
...
public:
	...
	static void updateSearchKeyword(QList<PLSNaverShoppingLIVESearchKeywordItemView *> &views);
...
private:
	Ui::PLSNaverShoppingLIVESearchKeywordItemView *ui;
