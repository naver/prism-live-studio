...
class LIBUI_API PLSLoadingView : public QFrame {
	Q_OBJECT
...
public:
	...
	static PLSLoadingView *newLoadingView(QWidget *parent, int absoluteTop, const QString &pathImage, const QSize &defaultSize);
