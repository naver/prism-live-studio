...
+ (UInt32)getEntryProperty:(io_registry_entry_t)entry
              propertyName:(CFStringRef)propertyName;
...
+ (UInt32)getEntryProperty:(io_registry_entry_t)entry
              propertyName:(CFStringRef)propertyName {
    CFDataRef dataRef = static_cast<CFDataRef>(IORegistryEntrySearchCFProperty(entry,
                                                                               kIOServicePlane,
                                                                               propertyName,
                                                                               kCFAllocatorDefault,
