...
public:
	virtual ~PLSChannelPublicAPI() = default;

	/*replace or add only one channel info */
	virtual void setChannelInfos(const QVariantMap &Infos, bool, bool) = 0;
