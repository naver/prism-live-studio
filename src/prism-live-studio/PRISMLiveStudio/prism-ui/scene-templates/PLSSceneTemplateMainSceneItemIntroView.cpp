...
PLSSceneTemplateMainSceneItemIntroView::PLSSceneTemplateMainSceneItemIntroView(QWidget *parent) : QWidget(parent), ui(new Ui::PLSSceneTemplateMainSceneItemIntroView)
{
	ui->setupUi(this);
