...
struct pls_frontend_callbacks : public obs_frontend_callbacks {
	...
	virtual pls_check_update_result_t pls_check_app_update(bool &is_force, QString &version, QString &file_url, QString &update_info_url, PLSErrorHandler::RetData &retData,
							       bool isNeedLatestApi) = 0;
	...
	virtual void pls_get_new_notice_Info(const std::function<void(const QList<PLSNoticeUpdateItem> &noticeInfos)> &noticeCallback) = 0;
	virtual QList<PLSNoticeUpdateItem> pls_get_new_notice_from_cache() = 0;
	...
	virtual pls::Button pls_alert_error_message(QWidget *parent, const QString &title, const pls_text_t &message, const QString &errorCode, const QString &userId, pls::Buttons buttons,
						    pls::Button defaultButton, const std::optional<int> &timeout, const QMap<QString, QVariant> &properties = QMap<QString, QVariant>()) = 0;
	virtual pls::Button pls_alert_error_message(QWidget *parent, const QString &title, const pls_text_t &message, const QString &errorCode, const QString &userId,
	...
	virtual void pls_open_cam_studio(QStringList arguments, QWidget *parent, bool isMobile) const = 0;
	...
	virtual void pls_sticker_source_start_update_sticker(obs_source_t *source) = 0;
	virtual void pls_sticker_source_start_add_sticker() = 0;
	virtual bool pls_sticker_source_cancel_update_sticker(obs_source_t *source) = 0;
	virtual void pls_sticker_source_apply_update_sticker(obs_source_t *source) = 0;
	virtual void pls_sticker_source_defaults_update_sticker(obs_source_t *source) = 0;
};
