...
OBSBasicInteraction::OBSBasicInteraction(QWidget *parent, OBSSource source_)
	: QDialog(parent),
	  ...
	  eventFilter(BuildEventFilter(parent))
{
...
OBSEventFilter *OBSBasicInteraction::BuildEventFilter(QObject *parent)
{
	return new OBSEventFilter(parent, [this](QObject *obj, QEvent *event) {
