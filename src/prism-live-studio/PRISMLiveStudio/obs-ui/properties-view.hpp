...
class WidgetInfo : public QObject,
		   public std::enable_shared_from_this<WidgetInfo> {
	Q_OBJECT
...
public:
	...
	OBSPropertiesView(OBSData settings, const char *type,
			  PropertiesReloadCallback reloadCallback,
			  int minSize = 0, bool bFromSetting = false);
...
#undef obj_constructor
	...
	void SetCustomContentWidth(bool setCustomContentWidth_)
	{
		setCustomContentWidth = setCustomContentWidth_;
	}
