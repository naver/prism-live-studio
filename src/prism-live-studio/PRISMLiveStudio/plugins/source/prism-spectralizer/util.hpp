...
#define T_MODE_BARS_BASIC               T_("BasicBars")
#define T_MODE_BARS_FILLET              T_("FilletBars")
#define T_MODE_BARS_LINEAR              T_("LinearBars")
#define T_MODE_BARS_GRADIENT            T_("GradientBars")
