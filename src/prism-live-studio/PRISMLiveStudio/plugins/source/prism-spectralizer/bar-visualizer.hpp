...
public:
	...
	~bar_visualizer() override;

	bar_visualizer(bar_visualizer const &) = delete;
	bar_visualizer &operator=(bar_visualizer const &) = delete;

	bar_visualizer(bar_visualizer &&) = delete;
	bar_visualizer &operator=(bar_visualizer &&) = delete;
