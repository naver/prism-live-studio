	...
	ui(new Ui::win_spout_output_settings)
{
	...
	ui->checkBox_auto->setText(obs_module_text("spoutoutputautostart"));
	ui->pushButton_start->setText(obs_module_text("spoutoutputstart"));
	ui->pushButton_stop->setText(obs_module_text("spoutoutputstop"));
