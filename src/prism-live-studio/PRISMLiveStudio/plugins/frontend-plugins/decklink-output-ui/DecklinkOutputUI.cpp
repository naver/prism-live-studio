...
void DecklinkOutputUI::SetupPropertiesView()
{
	...
	propertiesView = new OBSPropertiesView(settings, "decklink_output", (PropertiesReloadCallback)obs_get_output_properties, 170);
...
void DecklinkOutputUI::SetupPreviewPropertiesView()
{
	...
	previewPropertiesView = new OBSPropertiesView(settings, "decklink_output", (PropertiesReloadCallback)obs_get_output_properties, 170);
