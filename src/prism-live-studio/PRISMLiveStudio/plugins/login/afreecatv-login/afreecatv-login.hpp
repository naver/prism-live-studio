...
class PLSAfreecaTVLoginInfo : public PLSLoginInfo {
public:
	PLSAfreecaTVLoginInfo() = default;
...
private:
	...
	bool isAfreecaChannelLoginReturnUrl(const QString &urlString) const;

	QString m_jumpUrl;
	Q_DISABLE_COPY(PLSAfreecaTVLoginInfo)
};
