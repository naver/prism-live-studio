...
{
	//PRISM/LiuHaibin/20200221/#/change default value:keyint_sec,rate_control,profile,preset
#pragma region OBS - Enforce Streaming Service Restrictions
	...
	obs_data_set_default_string(data, "profile", "high");
	obs_data_set_default_string(data, "preset", "balanced");
#pragma endregion OBS - Enforce Streaming Service Restrictions
	...
	//PRISM/LiuHaibin/20200221/#/change default value:bitrate
	...
	// Picture Control
	//PRISM/LiuHaibin/20200221/#/change default value:P_INTERVAL_KEYFRAME
	obs_data_set_default_double(data, P_INTERVAL_KEYFRAME, 1.0);
